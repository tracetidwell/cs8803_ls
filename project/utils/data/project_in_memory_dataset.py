...
class ProjectInMemoryDataset(ProjectDataset):
    ...
    def __init__(self, root, transform=None, pre_transform=None,
                 pre_filter=None, raw_name='raw', processed_name='processed'):
        super(ProjectInMemoryDataset, self).__init__(root, transform, pre_transform, pre_filter, raw_name, processed_name)
